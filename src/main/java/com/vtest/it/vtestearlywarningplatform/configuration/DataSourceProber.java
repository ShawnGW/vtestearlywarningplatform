package com.vtest.it.vtestearlywarningplatform.configuration;
...
@Configuration
@MapperScan(basePackages = {"com.vtest.it.vtestearlywarningplatform.dao.prober"},sqlSessionTemplateRef ="probermtSqlsessionTemplate")
